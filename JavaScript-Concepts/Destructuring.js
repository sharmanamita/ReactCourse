// import { getUserById, users } from "./data";
...
function objectDestructuring() {
  const user = users[0];
  //   const name = user ? user.firstName : "No name";
  //   const email = user ? user.email : "No email";

  const { firstName, email } = users[0];
  console.log(`Name: ${firstName}, Email: ${email}`);
}

function arrayDestructuring() {
  // const framework = array[0];
  // const language = array[1];
  const [framework, language] = array;
